...
<style>
	.gb-humans-txt {
		--gb-humans-txt-bg: #282a36;
		--gb-humans-txt-header: #1d1f27;
		--gb-humans-txt-text: #f8f8f2;
		--gb-humans-txt-green: #50fa7b;
		--gb-humans-txt-purple: #bd93f9;
		--gb-humans-txt-yellow: #f1fa8c;
		--gb-humans-txt-pink: #ff79c6;
		--gb-humans-txt-blue: #8be9fd;
		--gb-humans-txt-comment: #6272a4;
		--gb-humans-txt-close: #ff5f56;
		--gb-humans-txt-minimize: #ffbd2e;
		--gb-humans-txt-maximize: #27c93f;
	}
	...
	.gb-humans-txt-window {
		background: var(--gb-humans-txt-bg);
	...
	.gb-humans-txt-window__header {
		align-items: center;
		background: var(--gb-humans-txt-header);
	...
	.gb-humans-txt-window__button--close {
		background: var(--gb-humans-txt-close);
	}

	.gb-humans-txt-window__button--minimize {
		background: var(--gb-humans-txt-minimize);
	}

	.gb-humans-txt-window__button--maximize {
		background: var(--gb-humans-txt-maximize);
	}
	...
	.gb-humans-txt-syntax__comment {
		color: var(--gb-humans-txt-comment);
		white-space: pre;
	}

	.gb-humans-txt-syntax__keyword,
	.gb-humans-txt-syntax__operator {
		color: var(--gb-humans-txt-pink);
	}
	...
	.gb-humans-txt-syntax__string {
		color: var(--gb-humans-txt-yellow);
	}

	.gb-humans-txt-syntax__path {
		color: var(--gb-humans-txt-purple);
	}
	...
	.gb-humans-txt__cursor {
		...
		background: var(--gb-humans-txt-text);
